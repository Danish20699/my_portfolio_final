...
const DepthCarousel = ({
  ...
  useEffect(() => {
    ...
    const onWheel = e => {
      ...
      // LOCAL MODIFICATION — diverges from the React Bits registry source.
      // Upstream advances the carousel on vertical wheel too, and calls
      // preventDefault() unconditionally. On a long scrolling page that
      // traps the scroll whenever the pointer is over this section: you
      // scroll down, the carousel spins, the page stays put.
      // Only horizontal intent (trackpad swipe, shift+wheel) drives the
      // rail now; plain vertical wheel falls through to the document.
      // Drag, arrows, dots, keyboard and autoplay are unaffected.
      // Re-apply this if you ever re-add the component from the registry.
